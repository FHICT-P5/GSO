 ...
 * @author frankcoenen
 */
public class BalieServerCustom extends Application {
    ...
    private Initializable replaceSceneContent(String fxml) throws Exception {
        ...
        InputStream in = BalieServerCustom.class.getResourceAsStream(fxml);
        loader.setBuilderFactory(new JavaFXBuilderFactory());
        loader.setLocation(BalieServerCustom.class.getResource(fxml));
        AnchorPane page;
        try {
